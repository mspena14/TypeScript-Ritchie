...
R// Permite manejar errores que se pueden presentar cuando ya nuestra app se encuentra terminada, nos ayuda a controlar esos errores antes de desplegarla, ayuda con el compilado, el orden del proyecto, el uso de diferentes herramientas de javascript. En resumen permite gestionar todo nuesto proyecto para que se acople a nuestras necesidades.
- ¿Qué ventajas ofrece TypeScript en comparación con JavaScript puro?
R// TypeScript maneja un tipado estatico que nos ayuda a manejar lo errores de tipado en nuestra aplicación, permitiendo controlar incluso los retornos de las funciones.

- ¿Por qué es importante verificar los tipos de datos en un proyecto de software?
R// Porque en muchos caso gracias a que no se especifica el tipo de un dato, nuestro proyecto se puede llegar a romper en cierto punto, generando contratiempos.
